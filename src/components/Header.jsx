...
const Header = () => {
  ...
  const getDebounced = useMemo(() => debounce(searchVal, 500), [navigate])
  ...
  return (
    <header className='md:h-16 h-auto pt-4 shadow-md bg-white fixed w-full z-40'>
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
        <div className=''>
          <Link to={"/"}>
            {/* <Logo w={90} h={50}/> */}
            <p className='text-2xl text-red-500'>Whizz<span className='text-blue-500'>Cart</span></p>
          </Link>
        </div>
      ...
      <div className= 'w-full py-4 px-4 bg-white md:hidden'>
